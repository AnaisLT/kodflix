...
export default function getGallery() {
    return [
      ...
      { id: 'star Trek', name: 'Star Trek Discovery', cover: StarTrek, synopsis: 'After a century of silence, war erupts between the Federation and Klingon Empire, with a disgraced Starfleet officer at the center of the conflict.'},
      ...
      { id: 'jessicajones', name: 'Jessica Jones', cover: JessicaJones, synopsis: 'Haunted by a traumatic past, she\'s also a gifted PI with super abilities... and quite a temperament.' },
      { id: 'goodomens', name: 'Good Omens', cover: GoodOmens, synopsis:'The End of the World is coming, which means a fussy Angel and a loose-living Demon who\'ve become overly fond of life on Earth are forced to form an unlikely alliance to stop Armageddon.'},
    ];
  }